...
const AdminItemManagement: React.FC = () => {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      try {
        const response = await axios.get('https://cloud-back-nlgv.onrender.com/api/auth/items'); // Adjust the endpoint URL as per your backend
  ...
  const handleDelete = async (_id: string) => { // Change id to _id
    if (window.confirm('Are you sure you want to delete this item?')) {
      try {
        await axios.delete(`https://cloud-back-nlgv.onrender.com/api/auth/items/${_id}`); // Adjust the endpoint URL
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isEditing) {
      ...
      // Update the item
      try {
        await axios.put(`https://cloud-back-nlgv.onrender.com/api/auth/items/${currentItem._id}`, currentItem); // Change id to _id
      ...
      // Add a new item
      try {
        const response = await axios.post('https://cloud-back-nlgv.onrender.com/api/auth/items', currentItem);
