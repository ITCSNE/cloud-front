...
export const FeedbackProvider = ({ children }: { children: ReactNode }) => {
  ...
  const addFeedback = async (feedback: Feedback) => {
    return await axios
      .post("https://cloud-back-nlgv.onrender.com/api/auth/feedback", feedback, {
        headers: {
  ...
  const getFeedbacks = async () => {
    console.log(token);
    await axios
      .get("https://cloud-back-nlgv.onrender.com/api/auth/feedbacks", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const updateFeedback = async (updatedFeedback: Feedback) => {
    return await axios
      .put(`https://cloud-back-nlgv.onrender.com/api/auth/feedback/reply/`, updatedFeedback, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const deleteFeedback = async (id: string) => {
    return await axios
      .delete(`https://cloud-back-nlgv.onrender.com/api/auth/feedback/reply/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
