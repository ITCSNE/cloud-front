...
export const SupplierProvider = ({ children }: { children: ReactNode }) => {
  ...
  const addSupplier = async (supplier: Supplier) => {
    ...
    return await axios
      .post("https://cloud-back-nlgv.onrender.com/api/auth/add/suppliers", supplierData, {
        headers: {
  ...
  const updateSupplier = async (updatedSupplier: Supplier) => {
    return await axios
      .put(
        `https://cloud-back-nlgv.onrender.com/api/auth/suppliers/${updatedSupplier._id}`,
        updatedSupplier,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const deleteSupplier = async (id: string) => {
    return await axios
      .delete(`https://cloud-back-nlgv.onrender.com/api/auth/suppliers/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const getSuppliers = async () => {
    return await axios
      .get("https://cloud-back-nlgv.onrender.com/api/auth/suppliers", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
